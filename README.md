...
![screensshot2](https://github.com/Varsha-dubey2002/Fyle-Frontend-development-challenge/blob/master/2%20(2).png)
...
```bash
https://github.com/Varsha-dubey2002/Fyle-Frontend-development-challenge.git
```
